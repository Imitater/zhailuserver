...
public class PaymentAllAdapter extends BaseQuickAdapter <PaymentDetailsBean.ServerBillListBean, BaseViewHolder>{
    public PaymentAllAdapter(int layoutResId, @Nullable List<PaymentDetailsBean.ServerBillListBean> data) {
