...
public class DistributionAdapter extends BaseQuickAdapter <PutOrderBean.OrdersListBean, BaseViewHolder>{
    public DistributionAdapter(int layoutResId, @Nullable List<PutOrderBean.OrdersListBean> data) {
