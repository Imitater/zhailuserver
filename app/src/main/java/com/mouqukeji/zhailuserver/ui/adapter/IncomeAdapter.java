...
public class IncomeAdapter extends BaseQuickAdapter <PaymentDetailsBean.ServerBillListBean, BaseViewHolder>{
    public IncomeAdapter(int layoutResId, @Nullable List<PaymentDetailsBean.ServerBillListBean> data) {
