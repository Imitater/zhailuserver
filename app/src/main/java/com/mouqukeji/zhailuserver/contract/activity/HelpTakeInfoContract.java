...
public interface HelpTakeInfoContract {
    interface View extends IBaseView {
        void orderInfo(TakeOrderInfoBean bean);
    ...
    interface Model extends BaseModel {
        Observable<BaseHttpResponse<TakeOrderInfoBean>> orderInfo(String order_id, String cate_id);
    ...
    abstract class Presenter extends BasePresenter<HelpTakeInfoContract.View, HelpTakeInfoContract.Model> {
        public abstract void orderInfo(String order_id,String cate_id, MultipleStatusView multipleStatusView);
